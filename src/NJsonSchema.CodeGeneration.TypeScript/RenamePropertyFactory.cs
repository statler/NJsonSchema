...
namespace NJsonSchema.CodeGeneration.TypeScript
{
    ...
    public static class RenamePropertyFactory
    {
        ...
        static Dictionary<string, Dictionary<string, string>> _dctRenames;
        /// <summary>
        /// 
        /// </summary>
        private static Dictionary<string, Dictionary<string, string>> DctRenames
        {
            get
            {
                if (_dctRenames == null) populateRenames();
                return _dctRenames;
            }
        }
        ...
        {
            _dctRenames = new Dictionary<string, Dictionary<string, string>>();
            ...
            //};
            //dctRenames["LotItpDetailDtoViewModel"] = dctRenames["LotItpdetailViewModel"];
            ...
            //};
            //_dctRenames["ApprovalRequestToViewModel"] = new Dictionary<string, string>()
            //{
            //    {"RequestTo", "RequestToId"},
            //    {"RequestToNavigation", "RequestToUser"}
            //};
            //_dctRenames["ApprovalRequestToDtoViewModel"] = new Dictionary<string, string>()
            //{
            //    {"RequestTo", "RequestToId"},
            //    {"RequestToNavigation", "RequestToUser"}
            //};
            //_dctRenames["PurchaseOrderViewModel"] = new Dictionary<string, string>()
            //{
            //    {"Poindex", "PoIndex"},
            //    {"Ponumber", "PoNumber"},
            //    {"Podate", "PoDate"},
            ...
            //};
            //_dctRenames["PurchaseOrderDtoViewModel"] = new Dictionary<string, string>()
            //{
            //    {"Poindex", "PoIndex"},
            //    {"Ponumber", "PoNumber"},
            //    {"Podate", "PoDate"},
            ...
            //    {"SupplierConfirmationByNavigation", "SupplierConfirmationByUser"}
            //};
            //_dctRenames["PurchaseOrderDetailViewModel"] = new Dictionary<string, string>()
            //{
